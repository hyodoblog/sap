...
// invitation
import groupInvitationRouter from './routes/invitation/group/index'
import groupAllInvitationRouter from './routes/invitation/group/all'
import participateUserInvitationRouter from './routes/invitation/participate-user/index'
...
// invitation
router.post(backRoutes.groupInvitation, groupInvitationRouter)
router.post(backRoutes.groupAllInvitation, groupAllInvitationRouter)
router.post(backRoutes.participateUserInvitation, participateUserInvitationRouter)
